...
# Auxiliary function
import src.models.main.model_utils as model_utils

# Loading libraries
from src.models.main.model_blocks import MLP, AttentionRNNEncoder
...
class CAMELOT(tf.keras.Model):
    ...
    def initialise_model(self, data, val_data, epochs, learning_rate, batch_size):
        ...
        self._initialise_enc_pred(data=data, val_data=val_data, 
