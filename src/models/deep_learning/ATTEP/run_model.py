...
parser.add_argument('--epochs', default=50, type=int, help="epochs for evaluate.py training phase.")
...
# Callback Parameters
parser.add_argument('--track_loss', default='L1', type=str, help="evaluate.py loss to track during training.")
